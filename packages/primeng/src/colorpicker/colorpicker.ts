...
import { OverlayOptions, OverlayService, SharedModule, TranslationKeys } from '@libreng/ui/api';
...
import type { ColorPickerChangeEvent } from '@libreng/ui/types/colorpicker';
import { ColorPickerPassThrough } from '@libreng/ui/types/colorpicker';
