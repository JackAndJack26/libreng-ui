...
fs.readFile(tsvFilePath, 'utf8', (err, data) => {
    ...
    changelogContent += `## [${version}](https://github.com/JackAndJack26/libreng-ui/tree/${version}) (${today})\n`;
    changelogContent += `[Full Changelog](https://github.com/JackAndJack26/libreng-ui/compare/${previousVersion}...${version})\n\n`;
