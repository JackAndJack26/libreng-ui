...
| promptLabel | string | - | Text to prompt password entry. Defaults to LibreNG UI I18N API configuration. |
...
| weakLabel | string | - | Text for a weak password. Defaults to LibreNG UI I18N API configuration. |
| mediumLabel | string | - | Text for a medium password. Defaults to LibreNG UI I18N API configuration. |
| maxLength | number | - | specifies the maximum number of characters allowed in the input element. **(Deprecated)** |
| strongLabel | string | - | Text for a strong password. Defaults to LibreNG UI I18N API configuration. |
