# MCP Server - LibreNG UI

Model Context Protocol (MCP) server for LibreNG UI component library. Provides AI assistants with comprehensive access to LibreNG UI component documentation.
