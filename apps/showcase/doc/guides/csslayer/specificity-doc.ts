...
import { InputSwitchModule } from '@libreng/ui/inputswitch';
    ...
    template: `
        <app-docsectiontext>
            <p>
                ...
                <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/@layer">MDN</a> to begin with. LibreNG UI wraps the built-in style classes under the <i>primeng</i> cascade layer to make the library styles easy to override. CSS in your app
            ...
            <p>
                ...
                the layers, we'd have to write a stronger css or use <i>!important</i> however, with layers, this does not present an issue as your CSS can always override LibreNG UI with a more straightforward class name such as
