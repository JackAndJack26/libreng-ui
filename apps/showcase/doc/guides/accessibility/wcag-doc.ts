    ...
    template: `
        <app-docsectiontext>
            <p>
                ...
                Web Consortium). WCAG consists of recommendations for making the web content more accessible. LibreNG UI components aim high level of WCAG compliancy in the near future.
            </p>
            <p>
