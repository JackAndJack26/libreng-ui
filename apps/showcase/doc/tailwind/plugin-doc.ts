    ...
    template: `
        <app-docsectiontext>
            <p>
                ...
                LibreNG UI and Tailwind CSS. It is designed to work both in styled and unstyled modes. In styled mode, for instance the semantic colors such as primary and surfaces are provided as Tailwind utilities e.g. <i>bg-primary</i>,
            ...
            <p class="mt-4">
                For a comprehensive starter guide, review the <a href="https://github.com/JackAndJack26/libreng-ui-examples/tree/main/primeng-quickstart-tailwind" target="_blank" rel="noopener noreferrer">primeng-quickstart-tailwind</a> repository which
