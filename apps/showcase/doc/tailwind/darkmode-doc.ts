...
@Component({
    ...
    template: `
        <app-docsectiontext>
            <p>
                In styled mode, LibreNG UI uses the <i>system</i> as the default <i>darkModeSelector</i> in theme configuration. If you have a dark mode switch in your application, ensure that <i>darkModeSelector</i> is aligned with the Tailwind dark
            ...
            <p>Suppose that, the darkModeSelector is set as <i>my-app-dark</i> in LibreNG UI.</p>
