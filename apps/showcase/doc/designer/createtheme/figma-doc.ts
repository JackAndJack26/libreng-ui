...
@Component({
    ...
    template: `<app-docsectiontext>
        ...
        <p>Open the PrimeOne UI Kit in which you've modified tokens. In the PrimeUI Theme Generator plugin, click the <i>Export</i> option to export all variable collections.</p>
