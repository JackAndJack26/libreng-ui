    ...
    template: `
        <app-docsectiontext>
            ...
            <p>
                ...
                source of truth. Prior to v20, LibreNG UI has its own fork in default styles and for the design tokens <i>{{ '@' }}primeng/themes</i> package is required. With v20, LibreNG UI receives the styles from
