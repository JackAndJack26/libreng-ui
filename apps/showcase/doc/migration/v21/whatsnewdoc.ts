...
@Component({
    ...
    template: `
        <app-docsectiontext>
            <p>LibreNG UI v21 represents a major advancement in PrimeTek's product vision. Key highlights of this release include:</p>
            ...
            <ul class="leading-normal px-10 list-disc">
                <li class="py-1">
                    The internal packages <i>@primeuix/styles</i> and <i>@libreng/themes</i> should be version <i>2.0.2</i> or higher. These packages are updated automatically with a fresh install. If you encounter any issues with visuals or
