...
@Component({
    ...
    template: `
        <app-docsectiontext>
            <p>
                At PrimeTek, we have been developing UI component libraries since 2008. The web continues to undergo technological advancements, and as a result, we have to modernize and update our libraries to stay relevant. LibreNG UI v18 is the
            ...
            <p>
                The most notable feature is the new <a routerLink="/theming">styled mode</a> implementation. Previous iterations use SASS at an external repo called <i>LibreNG UI-sass-theme</i> which requires compilation of a <i>theme.css</i>a file.
            ...
            <p>
                Components have been utilized more within other components, for instance Dialog close button is not actually a LibreNG UI button so that <i>closeButtonProps</i> can be used to enable the features of button like outlined, raised and
                more.
            </p>
        </app-docsectiontext>
    `
