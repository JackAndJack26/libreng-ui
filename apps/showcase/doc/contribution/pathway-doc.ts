...
@Component({
    ...
    template: `
        <app-docsectiontext>
            ...
            <p>If a contributor actively participates in the codebase and PRs, their role may be upgraded to a Committer level, providing direct commit access to the LibreNG UI codebase.</p>
