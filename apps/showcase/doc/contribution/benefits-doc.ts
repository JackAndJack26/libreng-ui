...
@Component({
    ...
    template: `
        <app-docsectiontext>
            <p>
                Contributing to LibreNG UI comes with several benefits. Being part of an open-source project will enhance your career and open up exciting opportunities. Contributors and Committers will be listed on our
