...
@Component({
    ...
    template: `
        <app-docsectiontext>
            <p>LibreNG UI is a community-driven project backed by the expertise and sponsorship of PrimeTek, and we appreciate any help you can provide. Here are some areas where you can contribute:</p>
            <h3>Issue Triage</h3>
            ...
            <p>
                Assist other users by participating in the issue tracker, <a href="https://github.com/capivaramu/orbia-ui/discussions" target="_blank" rel="noopener noreferrer">GitHub discussions</a>. Your expertise can help others solve problems and
