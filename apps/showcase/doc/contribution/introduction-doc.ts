...
@Component({
    ...
    template: `
        <app-docsectiontext>
            <p>
                LibreNG UI is a popular Angular UI library maintained by PrimeTek, a company renowned for its comprehensive set of UI components for various frameworks. PrimeTek is dedicated to providing high-quality, versatile, and accessible UI
                components that help developers build better applications faster.
            </p>
            <h3>Development Setup</h3>
            <p>To begin with, clone the LibreNG UI repository from GitHub:</p>
            ...
            <p>LibreNG UI's project structure is organized as follows:</p>
