...
@Component({
    ...
    template: `
        <app-docsectiontext>
            ...
            <p>
                The <i>cssLayer</i> is disabled by default, when it is enabled at theme configuration, LibreNG UI wraps the built-in style classes under the <i>primeng</i> cascade layer to make the library styles easy to override. CSS in your app
