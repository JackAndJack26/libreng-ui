...
@Component({
    ...
    template: `
        <app-docsectiontext>
            <p>
                The <a href="https://llmstxt.org/" target="_blank" rel="noopener noreferrer">llms.txt</a> file is an industry standard that helps AI models better understand and navigate the LibreNG UI documentation. It lists key pages in a
