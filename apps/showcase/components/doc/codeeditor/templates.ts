...
import { $t, updatePreset, updateSurfacePalette } from '@libreng/themes';
import Aura from '@libreng/themes/aura';
import Lara from '@libreng/themes/lara';
import Material from '@libreng/themes/material';
import Nora from '@libreng/themes/nora';
