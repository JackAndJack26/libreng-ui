...
@Component({
    ...
    standalone: true,
    imports: [AppDoc],
    template: `<app-doc docTitle="Configuration - LibreNG UI" header="Configuration" description="Application wide configuration for LibreNG UI." [docs]="docs" docType="page"></app-doc>`
})
