        ...
        <div>
            <div class="flex flex-col md:flex-row mb-8 gap-8">
                ...
                <div class="card !m-0 flex-1 !bg-primary !text-primary-contrast font-medium">
                    ...
                    <p class="m-0 leading-normal text-lg">
                        With PRO support, it's easy to support, tune, and add features to LibreNG UI as an in-house library. With the exclusive services of a PRO account, you no longer need to post questions in the community forum and the community
            ...
            <div class="grid grid-cols-3 gap-8 mb-8">
                <div class="card !m-0 col-span-full lg:col-span-1">
                    ...
                    <a
                        href="mailto:contact@primetek.com.tr?subject=LibreNG UI%20PRO%20Support"
                ...
                <div class="card !m-0 col-span-full lg:col-span-2">
                    ...
                    <ul class="flex flex-col gap-4 list-none m-0 p-0 text-lg">
                        ...
                        <li>
                            ...
                            <span class="leading-normal"
                                >If the issue requires an update in the library, it gets published to npm by as part of the public LibreNG UI package. A patch update on an older version can also be requested if you are not using the latest version.
                            </span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="flex flex-col md:flex-row text-lg gap-8">
                    ...
                    <div class="flex-1 flex flex-col gap-8">
                        <div>
                            ...
                            <p class="!m-0 leading-normal">No, changes become part of the LibreNG UI core and pushed to the public npm package on next update.</p>
                        </div>
                        <div>
                            <div class="leading-normal mb-2 font-semibold">Who provides the support service?</div>
                            <p class="!m-0 leading-normal">Support service is provided by the LibreNG UI team at PrimeTek.</p>
                        </div>
                        <div>
