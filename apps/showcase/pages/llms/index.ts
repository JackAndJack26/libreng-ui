...
@Component({
    ...
    standalone: true,
    imports: [AppDoc],
    template: ` <app-doc docTitle="LLMs.txt - LibreNG UI" header="LLMs.txt" description="LLM-optimized documentation endpoints for LibreNG UI components." [docs]="docs" docType="page"></app-doc> `
})
