    ...
    animationFeaturesData1 = [
        ...
        },
        {
            ...
            description: `Atlantis uses Figma as the design tool. It will be possible to download the Figma file after your purchase. You can
                <a href="https://www.figma.com/design/2aOISJWanQAd4Kzu8BLYe7/Preview-%7C%C2%A0Atlantis-%7C-2.0.0?node-id=1303-749&t=PVvmnN9FxL8FMgZf-1" target="_blank" rel="noopener noreferrer">preview the Figma file</a> before the purchase. Note that LibreNG UI UI components are excluded from the
