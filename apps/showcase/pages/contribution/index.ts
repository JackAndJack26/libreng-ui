...
@Component({
    ...
    standalone: true,
    imports: [AppDoc],
    template: ` <app-doc docTitle="Contribution - LibreNG UI" header="Contribution Guide" description="Welcome to the LibreNG UI Contribution Guide and thank you for considering contributing." [docs]="docs"></app-doc> `
})
