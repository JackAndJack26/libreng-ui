...
@Component({
    ...
    standalone: true,
    imports: [AppDoc],
    template: ` <app-doc title="Custom Icons - LibreNG UI" header="Custom Icons" description="LibreNG UI components can be used with any icon library using the templating features." [docs]="docs" docType="page"></app-doc>`
})
